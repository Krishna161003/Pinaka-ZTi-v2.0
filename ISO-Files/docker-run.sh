...
mkdir -p /home/pinakasupport/ssl
cp keycloak.crt keycloak.key keystore.p12 /home/pinakasupport/ssl/
cp keycloak.crt keycloak.key /home/pinakasupport/.pinaka_wd/Pinaka-ZTi-v2.0/flask-back/
chmod 644 /home/pinakasupport/ssl/keycloak.* /home/pinakasupport/ssl/keystore.p12
...
sudo systemctl enable pinakazti-v2.0-back.service
sudo systemctl start pinakazti-v2.0-back.service