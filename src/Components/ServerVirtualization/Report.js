...
const Report = ({ onDeploymentComplete }) => {
  ...
  return (
    <div style={{ padding: '20px' }}>
      ...
      <Divider />
      <Card title={`Server Virtualization Deployment Progress for ${cloudName} (${nodeIpsTitle})`}>
        <Row gutter={24}>
          <Col span={24}>
              ...
              {deploymentInProgress ? (
                <>
                  <img
                    ...
                    decoding="async"
                    draggable={false}
                    style={{ width: 580, height: 180, objectFit: 'contain', display: 'block', transform: 'translateZ(0)', willChange: 'transform' }}
                  />
                ...
                <>
                  <img
                    ...
                    loading="eager"
                    decoding="sync"
                    style={{ width: 580, height: 180, objectFit: 'contain', display: 'block' }}
                  />
